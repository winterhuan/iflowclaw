...
If `product-marketing-context.md` exists in the current working directory, read it before editing. Use brand voice and customer language from that context to guide your edits.
